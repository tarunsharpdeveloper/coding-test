...
Route::middleware('auth:sanctum')->get('/tasks/{task}', [App\Http\Controllers\TaskController::class, 'edit']);
Route::middleware('auth:sanctum')->post('/tasks', [App\Http\Controllers\TaskController::class, 'store']);
Route::middleware('auth:sanctum')->post('/tasks/{id}', [App\Http\Controllers\TaskController::class, 'update']);
Route::middleware('auth:sanctum')->delete('/tasks/{task}', [App\Http\Controllers\TaskController::class, 'destroy']);
Route::middleware('auth:sanctum')->get('/count', [App\Http\Controllers\TaskController::class, 'cardCountTotal']);
